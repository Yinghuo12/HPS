...
private:
    RWMutexType m_mutex;
    std::unordered_map<std::string, Servlet::ptr> m_datas;  // 精准匹配: uri(/yinghuo/xxx) -> servlet
    std::vector<std::pair<std::string, Servlet::ptr> > m_globs;  // 模糊匹配: uri(/yinghuo/*) -> servlet
