...
void test_sock() {
    ...
    // inet_pton(AF_INET, "115.239.210.27", &addr.sin_addr.s_addr);  // www.baidu.com
    inet_pton(AF_INET, "1.1.1.1", &addr.sin_addr.s_addr);  // cloudflare dns
    // inet_pton(AF_INET, "34.194.166.244", &addr.sin_addr.s_addr);  // http://httpbin.org
